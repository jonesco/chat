  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          right: hasChatStarted ? `${chatPanelWidth}px` : '0px',
      ...
      <div 
        className="fixed bottom-6 left-16 transition-all duration-300"
        style={{ right: hasChatStarted ? `${chatPanelWidth + 16}px` : '16px' }}
      >
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <div className={`bg-[#262626] shadow-lg relative z-10 transition-all duration-300 ${isInputExpanded ? 'rounded-3xl' : 'rounded-full'}`}>
                ...
                <div className={`border-t border-[#393939] px-4 transition-all duration-300 ${isInputExpanded ? 'max-h-20 py-3 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
